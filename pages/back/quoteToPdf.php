...
$query = $connect->prepare('SELECT d.idDevis,d.titre,d.description,DATE_FORMAT(d.dateEmission,"%d/%m/%Y") as dateEmission,d.prix,p.nom,p.prenom FROM devis d,personne p WHERE d.FK_idPersonne = p.idPersonne AND idDevis = :idDev ');
$query->execute([
...
class PDF extends FPDF
    ...
    $pdf->Cell(100, 20, 'Client : ' . $name . ' ' . $firstname, 1, 0, 'C');
    $pdf->ln(5);
